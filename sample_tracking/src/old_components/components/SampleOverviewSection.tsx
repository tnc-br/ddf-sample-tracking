...
const SampleOverviewSection = ({ selectedDoc }: Props) => {
    ...
    <div className="details">
      ...
      <div className="detail-row">
        <div className="detail">
          ...
          <span className="detail-value">
            {selectedDoc['measureing_height'] || 'unknown'}
          </span>
        </div>
        <div className="detail">
          <span className="detail-name">{t('observations')}</span>
          <span className="detail-value">
            {selectedDoc['observations'] || 'unknown'}
          </span>
        </div>
      </div>
      <div className="detail-row">
        <div className="detail">
          ...
          <span className="detail-value">
            {selectedDoc['sample_type'] || 'unknown'}
          </span>
        </div>
      </div>
      <div className="detail-row">
      ...
      <div className="detail-row">
        <div className="detail">
          ...
          <span className="detail-value">
            {selectedDoc['points'] ? selectedDoc['points'].length : ''}
          </span>
        </div>
      </div>
    </div>
