 ...
 */
const DeforestationAlertsSection = ({ selectedDoc }: Props) => {
    ...
    <div>
      {selectedDoc.alerts ? (
        <div className="details">
          <div className="section-title">{t('nearbyDeforestationAlerts')}</div>{' '}
          <table className="w-full border-collapse border border-gray-300 bg-white rounded-lg overflow-hidden shadow-sm table-alerts">
            ...
            <tbody>
              {selectedDoc.alerts.map((alert: any) => (
                <tr key={alert['alertCode']}>
                  ...
                  <td>
                    <a target="_blank" href={alert['before']['url']}>
                      <img
                        src={alert['before']['url']}
                  ...
                  <td>
                    <a target="_blank" href={alert['after']['url']}>
                      <img
                        src={alert['after']['url']}
          ...
          <div className="alerts-source-footer">
            <Trans i18nKey="nearbyDeforestationAlertsSource" t={t}>
              Deforestation alerts are provided by{' '}
              <a target="_blank" href="https://alerta.mapbiomas.org/">
                MapBiomas Alerta
              </a>
            </Trans>
          </div>
