# Lista Completa de Campos do Formulário de Samples

## 📋 CAMPOS IDENTIFICADOS

### **BasicInfoTab.tsx**

1. **sample_name** - Nome da amostra (obrigatório)
2. **status** - Status da amostra (select)
3. **species** - Espécies de árvore (select com busca)
4. **trusted** - Origem (select: unknown/known/uncertain)
5. **collection_site** - Local de coleta (condicional)
6. **lat** - Latitude (condicional)
7. **lon** - Longitude (condicional)
8. **state** - Estado (select, condicional)
9. **municipality** - Município (select, condicional)
10. **date_collected** - Data de coleta (date picker)
11. **collected_by** - Coletado por (supplier/my_org)
12. **supplier** - Fornecedor (condicional se collected_by === 'supplier')
13. **city** - Cidade

### **SampleMeasurementTab.tsx**

14. **measureing_height** - Altura de medição
15. **sample_type** - Tipo de amostra (select: disk/triangular/chunk/fiber)
16. **diameter** - Diâmetro
17. **avp** - AVP
18. **mean_annual_temperature** - Temperatura média anual
19. **mean_annual_precipitation** - Precipitação média anual
20. **observations** - Observações (textarea)

### **Dados Isotópicos (Arrays)**

21. **d18O_cel** - Array de valores δ18O celulose
22. **d18O_wood** - Array de valores δ18O madeira
23. **d15N_wood** - Array de valores δ15N madeira
24. **n_wood** - Array de valores N madeira
25. **d13C_wood** - Array de valores δ13C madeira
26. **c_wood** - Array de valores C madeira
27. **c_cel** - Array de valores C celulose
28. **d13C_cel** - Array de valores δ13C celulose

## 🔍 VALIDADOR ZOD COMPLETO
...
- **Transformação de tipos** (string → number para coordenadas)
- **Validação de ranges** (latitude/longitude)
- **Arrays dinâmicos** para dados isotópicos
