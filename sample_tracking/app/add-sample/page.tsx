...
export default function AddSample() {
    ...
    function onCreateSampleClick(sampleId: string, formSampleData: Sample) {
        ...
        const sampleData = {
            ...
            code_lab: sampleId,
            oxygen: formSampleData.oxygen ? formSampleData.oxygen.map((value: string) => parseFloat(value)) : [],
            nitrogen: formSampleData.nitrogen ? formSampleData.nitrogen.map((value: string) => parseFloat(value)) : [],
            n_wood: formSampleData.n_wood ? formSampleData.n_wood.map((value: string) => parseFloat(value)) : [],
            carbon: formSampleData.carbon ? formSampleData.carbon.map((value: string) => parseFloat(value)) : [],
