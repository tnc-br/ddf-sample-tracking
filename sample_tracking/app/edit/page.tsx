...
import { type Sample, type UserData, confirmUserLoggedIn, getUrlParam, getDocRefForTrustedValue } from '../utils';
...
export default function Edit() {
    ...
    const sampleId = getUrlParam('id');
    const trusted = getUrlParam('trusted');
