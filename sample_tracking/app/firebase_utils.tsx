import { getFirestore, getDocs, collection, query, or, and, where, getDoc, doc, setDoc } from "firebase/firestore";
import * as utils from './utils';

export async function getSamplesFromCollection(userData: utils.UserData, collectionName: string): Promise<Map<string, Map<string, string>>[]> {
